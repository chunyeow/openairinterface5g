...
int main(int argc, char **argv)
{
  ...
  for(SNR_ul = snr0_ul; SNR_ul<=snr1_ul; SNR_ul+=0.25) {
    ...
    //BLER and Throughput
    fprintf(bler_fd,"%f,%d,%d,%d,%e,%e,%e;\n",SNR_ul,n_errors_dl,trials_dl,n_errors_ul,relay_delay,(double)(n_errors_dl + n_errors_ul)/trials_dl,
            (1-((double)(n_errors_dl + n_errors_ul)/trials_dl))*relay_delay*TBS*6*100);
