function [Ratepersec_4Qam_siso,Ratepersec_16Qam_siso,Ratepersec_64Qam_siso ] = ...
    calc_rps_siso_2(estimates_UE_1)
...
for i = 1:length(estimates_UE_1)
   RS_sum_4Qam = sum(chcap_siso(1,:,i));
   RS_sum_16Qam = sum(chcap_siso_16(1,:,i));
   RS_sum_64Qam = sum(chcap_siso_64(1,:,i));
...
Ratepersec_4Qam_siso = sum(Frame_DL_sum_4Qam(:));
Ratepersec_16Qam_siso = sum(Frame_DL_sum_16Qam(:));
Ratepersec_64Qam_siso = sum(Frame_DL_sum_64Qam(:));
