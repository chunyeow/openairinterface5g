...
*  The JSON value is stored in the file "outputGET.txt"
*******************************************************/
...
/*******************************************************
*  Stores a JSON value (a Policy) using a HTTP request
********************************************************/
...
/**********************************************************
*  Stores a JSON value (a Measurement) using a HTTP request
***********************************************************/
...
/********************************************************
*  Stores a JSON value (a Decision) using a HTTP request
*********************************************************/
...
/********************************************************
*  Deletes entities using a HTTP request
*********************************************************/
