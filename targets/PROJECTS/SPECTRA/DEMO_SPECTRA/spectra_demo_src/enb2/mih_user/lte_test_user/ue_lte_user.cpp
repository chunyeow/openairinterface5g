...
// 
//     log_(0, "Meausrement Type: ", lpr.param.type);
//     if(odtone::mih::link_param_val *value = boost::get<odtone::mih::link_param_val>(&lpr.param.value)){
//         log_(0, "Meausrement Value: ", *value);
//         
//     };
//     const odtone::mih::threshold *th;
    for (odtone::mih::link_param_rpt_list::iterator i=lprl.begin(); i!=lprl.end(); i++)
    {
//             odtone::mih::link_param_lte * index = boost::get<odtone::mih::link_param_lte>(&i->param.type);
//             int val = (short)*index;
//             log_(0, "Meausrement Type: index ", *index);
            log_(0, "Meausrement Type: --- 0 => RSRP  ----- 1=>RSRQ  ", i->param.type);
//             log_(0, "Meausrement Type: ", MeasurementTypes[index]);
//                         log_(0, "Meausrement Type: ", &i->param.type);
...
//         if (th = boost::get<odtone::mih::threshold> (&i->thold))
//         {
//             log_(0, "Threshold crossed ", boost::get<odtone::mih::link_param_val> (i->param.value));
//         }
//         else
//         {
//             log_(0,"Regular Report");
//         }
    }
