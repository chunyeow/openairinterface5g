  ...
  if (strcmp(argv[1], "class")==0)
  {
    ...
    if (strcmp(argv[2], "list")==0)
    {
      ...
      for(cli=0; cli<msgrep[0]; ++cli)
      {
        ...
        switch(list[cli].fct)
        {
        case NAS_FCT_QOS_SEND:printf("qos\t");break;
        case NAS_FCT_DEL_SEND:printf("del\t");break;
        case NAS_FCT_CTL_SEND:printf("ctl\t");break;
        case NAS_FCT_DC_SEND:printf("dc\t");break;
        default:printf("?\t");
        }
        ...
        case 4:
          ...
          printf("%s/%u\t", addr, list[cli].dplen);break;
        case 6:
        ...
        {
        case IPPROTO_UDP:
          printf("(udp, %u, %u)\t\n", list[cli].sport, list[cli].dport);break;
        case IPPROTO_TCP:
          printf("(tcp, %u, %u)\t\n", list[cli].sport, list[cli].dport);break;
        case IPPROTO_ICMP:
          printf("(icmp4, %u, %u)\t\n", list[cli].sport, list[cli].dport);break;
